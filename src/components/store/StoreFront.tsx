    ...
    return (
      <div style={{background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:14,overflow:"hidden",display:"flex",flexDirection:"column",transition:"border-color .2s",height:"100%"}}
        ...
        <div style={{padding:"10px 12px 12px",flex:1,display:"flex",flexDirection:"column",gap:5}}>
          ...
          {p.description&&<p style={{fontSize:10,color:"#666",lineHeight:1.4,flex:1}}>{p.description}</p>}
        ...
        <div className="pad">
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10}}>
            ...
            <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",flexShrink:0}}>
              <a href="/mayorista" style={{padding:"7px 12px",borderRadius:8,background:"rgba(0,180,216,.1)",border:"1px solid rgba(0,180,216,.3)",color:"#00B4D8",fontSize:12,fontWeight:600,textDecoration:"none",whiteSpace:"nowrap"}}>
                {"📦 Mayorista"}
              </a>
      ...
      <footer style={{borderTop:"1px solid #e5e7eb",padding:"24px 0",background:"#f9fafb"}}>
        <div className="pad" style={{display:"flex",flexWrap:"wrap",gap:20,justifyContent:"space-between",alignItems:"center"}}>
          <div>
            ...
            <p style={{fontSize:12,color:"#666",marginTop:2}}>{"🕐 Lunes a Viernes: 9-12 y 16-20hs"}</p>
          </div>
