...
useEffect(()=>{
 ...
 const InstallButton = () => {
  ...
  <span style={{fontSize:9,opacity:.85}}>Tocá para ver</span>
    ...
    {/* BARRA SUPERIOR */}
<div style={{background:"#f9fafb",borderBottom:"1px solid #e5e7eb",padding:"6px 12px",display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
  <a href={`https://wa.me/${WA}?text=${encodeURIComponent("Hola! Quiero hacer una consulta.")}`} target="_blank"
    style={{display:"flex",alignItems:"center",gap:5,padding:"5px 12px",background:"#25D366",borderRadius:20,color:"#fff",textDecoration:"none",fontWeight:600,fontSize:11,whiteSpace:"nowrap"}}>
